...
import streamlit as st
from model.DiseaseModel import DiseaseModel
from model.helper import prepare_symptoms_array
...
# Load an image for the sidebar or content area
...
# sidebar
with st.sidebar:
    st.title("CuraAI - An advanced diagnostic webapp")
    ...
    st.title('About')
    st.info(
    "This is a simplified medical risk prediction system. "
    "Please note that this is a demonstration and should not "
    "be used for actual medical diagnosis. Always consult "
